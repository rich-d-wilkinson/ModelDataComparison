## Code to show an example of fitting Gaussian Processes to data:
# Code from http://www.jameskeirstead.ca/blog/gaussian-process-regression-with-r/#code
#reproduces an example from Rasmussen and Williams book:
